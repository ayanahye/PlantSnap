...
describe('ListResult Component', () => {
  it('renders Link to detail page with data-testid', () => {
    ...
    const testData = [
      { image: { url: '', alt: 'Alt 1' }, name: 'Plant 1', score: 0.9, sciName: 'plant1' },
      { image: { url: '', alt: 'Alt 2' }, name: 'Plant 2', score: 0.8, sciName: 'plant2' },
    ];
    ...
    testData.forEach((result, index) => {
      ...
      expect(linkElements[index]).toHaveAttribute('href', `/detail/${result.sciName}`);
    });
  });
});
