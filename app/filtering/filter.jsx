                    ...
                    <div className="filterFullArea">
                        <div className="filterBlock">
                            ...
                            <div className="dropdowns">
                                ...
                                <Dropdown data={careGuides} name="Care Guides" onOptionChange={handleOptionChange} id="option0" data-testid="option0"/>
                                <Dropdown data={dataNames} name="Names" onOptionChange={handleOptionChange} id="option1" data-testid="option1"/>
                                <Dropdown data={dataSizes} name="Sizes" onOptionChange={handleOptionChange} id="option2" data-testid="option2"/>
                                <Dropdown data={dataEdible} name="Edible" onOptionChange={handleOptionChange} id="option3" data-testid="option3"/>
                                <Dropdown data={dataMaintenance} name="Maintenance" onOptionChange={handleOptionChange} id="option4" data-testid="option4"/>
                                <Dropdown data={dataPoisonous} name="Poisonous" onOptionChange={handleOptionChange} id="option6" data-testid="option6"/> 
                                </div>
                            </div>
                        </div>
                    </div>
